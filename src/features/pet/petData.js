...
export const PET_DATA = {
    [PET_SPECIES.DRAGON]: {
        ...
        evolution: {
            lv10: { appearanceId: 'dragon_lv2', name: '은하룡' },
            lv20: { appearanceId: 'dragon_lv3', name: '스텔라곤' },
        }
    },
    [PET_SPECIES.RABBIT]: {
        name: '버니니',
        ...
        evolution: {
            lv10: { appearanceId: 'rabbit_lv2', name: '버닉스' },
            lv20: { appearanceId: 'rabbit_lv3', name: '하이버닉스' },
        }
    },
    [PET_SPECIES.TURTLE]: {
        name: '새싹치',
        ...
        evolution: {
            lv10: { appearanceId: 'bird_lv2', name: '꽃잎치' },
            lv20: { appearanceId: 'bird_lv3', name: '열매치' },
        }
    },
};
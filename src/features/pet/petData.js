...
return `'${attacker.name}'이(가) 체력을 ${healAmount} 회복했습니다! ✨`;
    ...
    SHOCK_SCRATCH: {
        ...
        element: '번개',
        basePower: 25,
        description: '번개를 두른 손톱으로 할큅니다. 25% 확률로 상대를 1턴 경직시킵니다.',
...
,
    ...
    BLOSSOM_CURRENT: {
        ...
        element: '물',
        basePower: 24,
        description: '벚꽃잎이 섞인 해류로 상대를 감싸 약한 피해를 주고 물결표식을 1개 남깁니다. 표식 수 1개당 자신의 최대 HP 5%를 회복하며, 대기 펫도 회복량의 40%를 함께 회복합니다.',

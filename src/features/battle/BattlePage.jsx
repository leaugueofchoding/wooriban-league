    ...
    return (
        <>
            <BattleDuelView
                ...
                handleToggleBattleFullscreen={handleToggleBattleFullscreen}
                ...
                hitState={hitState}
                animState={animState}
                ultimateSecretHide={ultimateSecretHide}
                introActive={introActive}
                switchIntro={switchIntro}
                dotEffect={dotEffect}
                formatBattleLogForDisplay={formatBattleLogForDisplay}
                pendingSwitchForMe={pendingSwitchForMe}
                pendingSwitchPets={pendingSwitchPets}
                handleFaintedPetSwitch={handleFaintedPetSwitch}
                isProcessing={isProcessing}
                isQuizBlockedByCc={isQuizBlockedByCc}
                isFrozen={isFrozen}

...
const DarkenOverlay = styled.div`
  /* M2_SKILL_PREVIEW_DARKEN_SCOPE_PATCH
     fixed를 쓰면 스킬 도감 프리뷰에서도 브라우저 전체가 암전됩니다.
     absolute로 두어 BattleSkillEffect가 놓인 부모 영역 안에서만 암전되게 합니다. */
  position: absolute;
  inset: 0;
  width: 100%;
  height: 100%;
...
const BattleSkillEffect = ({ type, isMine }) => {
  ...
  const glowMap = {
    ...
    POISON: '#69db7c', SEED: '#69db7c', LEECH_SEED_HEAL_MULTI: '#40c057', VINE: '#40c057', VINE_WHIP_MULTI: '#40c057', ARROW: '#69db7c',
    WATER_BALL: '#4dabf7',

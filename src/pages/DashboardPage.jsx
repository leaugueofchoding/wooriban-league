...
import {
    useLeagueStore, useClassStore
} from '../store/leagueStore';
import {
    auth, getActiveGoals, donatePointsToGoal, getPlayerSeasonStats
} from '../api/firebase';
...
function DashboardPage() {
    ...
    const { players, missions, missionSubmissions, avatarParts, titles, standingsData, teams, isLoading, currentUser, fetchInitialData } = useLeagueStore();

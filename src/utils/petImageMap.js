...
export const petImageMap = {
    ...
    turtle_lv2_idle: bird2_portrait,
    turtle_lv2_battle: bird2_back,
    turtle_lv2_brace: bird2_crunch,
    turtle_lv2_brace_back: bird2_crunch_back,
    turtle_lv3_idle: bird3_portrait,
    turtle_lv3_battle: bird3_back,
    turtle_lv3_brace: bird3_crunch,
    turtle_lv3_brace_back: bird3_crunch_back,
};